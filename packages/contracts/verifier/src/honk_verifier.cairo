use super::honk_verifier_circuits::{
    is_on_curve_bn254, run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_13_circuit,
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_13_PUB_24_circuit,
};
...
mod UltraStarknetHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_HONK_SUMCHECK_SIZE_13_PUB_24_circuit, vk,
    };
    ...
    impl IUltraStarknetHonkVerifier of super::IUltraStarknetHonkVerifier<ContractState> {
        fn verify_ultra_starknet_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_13_PUB_24_circuit(
            ...
            assert(msm_hint.len() == 49 * 12, 'wrong glv&fakeglv hint size');
